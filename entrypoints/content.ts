...
export default defineContentScript({
  ...
  async main() {
    ...
    function postAndWait<T>(msg: Record<string, unknown>, responseType: string): Promise<T> {
    ...
    browser.runtime.onMessage.addListener(
      (message: { type: string; data?: Record<string, string> }, _sender: browser.Runtime.MessageSender, sendResponse: (response: unknown) => void) => {
